...
/* useful for keeping all of one particular query's data in
   one place */
...
int ndo_empty_queue_event_handler();
int ndo_empty_queue_host_check();
int ndo_empty_queue_service_check();
int ndo_empty_queue_comment();
int ndo_empty_queue_downtime();
int ndo_empty_queue_flapping();
int ndo_empty_queue_host_status();
int ndo_empty_queue_service_status();
int ndo_empty_queue_contact_status();
int ndo_empty_queue_acknowledgement();
int ndo_empty_queue_statechange();
int ndo_empty_queue_notification();
int ndo_empty_queue_contact_notification();
int ndo_empty_queue_contact_notification_method();
...
/* startup/object writing identification */
