...
#define NDOMOD_PROCESS_CONTACT_NOTIFICATION_DATA         67108864
#define NDOMOD_PROCESS_CONTACT_NOTIFICATION_METHOD_DATA  134217728

#define NDOMOD_PROCESS_EVERYTHING                        134217727
