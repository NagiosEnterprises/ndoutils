...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Current and historical host and service acknowledgements';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Command definitions';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical host and service comments';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Configuration files';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Configuration file variables';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='NDO2DB daemon connection information';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Contact addresses';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Contact host and service notification commands';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Contactgroup members';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Contactgroup definitions';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical record of contact notification methods';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical record of contact notifications';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Contact definitions';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Contact status';
...
CREATE TABLE `nagios_customvariables` (
  ...
  KEY `varname` (`varname`)
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Custom variables';
...
CREATE TABLE `nagios_customvariablestatus` (
  ...
  KEY `varname` (`varname`)
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Custom variable status information';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical scheduled host and service downtime';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical host and service event handlers';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical record of processed external commands';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Current and historical record of host and service flapping';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Parent hosts';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical host checks';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Host dependency definitions';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Host escalation definitions';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Hostgroup members';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Hostgroup definitions';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Current host status information';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Location names of various Nagios installations';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical record of log entries';
...
CREATE TABLE `nagios_notifications` (
  ...
  UNIQUE KEY `instance_id` (`instance_id`,`object_id`,`start_time`,`start_time_usec`)
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical record of host and service notifications';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Current and historical objects of all kinds';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical Nagios process events';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Current program status information';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Runtime variables from the Nagios daemon';
...
CREATE TABLE `nagios_scheduleddowntime` (
  ...
  UNIQUE KEY `instance_id` (`instance_id`,`object_id`,`entry_time`,`internal_downtime_id`)
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Current scheduled host and service downtime';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical service checks';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Service dependency definitions';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Service escalation definitions';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Servicegroup members';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Servicegroup definitions';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Service definitions';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Current service status information';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical host and service state changes';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical system commands that are executed';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Current Nagios event queue';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Historical events from the Nagios event queue';
...
) ENGINE=MyISAM DEFAULT CHARSET=ascii COMMENT='Timeperiod definitions';
